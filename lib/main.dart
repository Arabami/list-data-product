...
class _ProductListPageState extends State<ProductListPage> {
  List<Product> productList = [
    ...
    Product("Product Makanan", 150000),
    Product("Product Sparepart", 75000),
    Product("Product Bando 2", 120000),
    Product("Product Bando 90 Cagak", 90000),
    Product("Product Bando 20 Daun", 180000),
    Product("Product Bando DN", 200000),
    Product("Product Makeup", 85000),
    Product("Product Gelas", 160000),
    Product("Product Piring", 130000),
  ];
